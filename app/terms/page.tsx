...
export const metadata = {
  ...
  description:
    "Flumberico's terms of service for AI job search automation with 30-day interview guarantee. Terms for applying to 200+ jobs while you sleep with 83% success rate.",
  keywords:
    "Flumberico terms of service, AI job search terms, automated job applications terms, 30-day interview guarantee terms, ATS optimization terms, job search automation terms, service agreement",
  openGraph: {
    title: "Terms of Service - Flumberico AI Job Search Automation",
    description:
      "Terms and conditions for AI job search automation service with 30-day interview guarantee and 200+ monthly applications.",
    type: "website",
  },
}
