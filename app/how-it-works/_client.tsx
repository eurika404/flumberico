        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center animate-slide-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              4-step AI job search automation that applies to 200+ jobs while you sleep. 83% success rate with 30-day
              interview guarantee.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Land interviews in 30 days or we pay you $500. No-risk job search with proven 83% success rate.",
                icon: "💰",
              },
              {
                title: "Custom Resume AI",
                description:
                  "Every application gets a tailored resume. No more generic 'one-size-fits-all' submissions that get rejected.",
                icon: "📄",
              },
              {
                title: "Real-time Analytics",
                description:
                  "Track applications, view responses, and optimize your job search strategy with live data insights.",
                icon: "📊",
              },
            ].map((feature, index) => (
              <div
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join 3,800+ professionals who've transformed their job search from 40 hours weekly to automated AI success.
            Limited to 10,000 spots - 78% filled.
          </p>
          <div className="flex justify-center gap-4 mb-8">
            <div className="text-sm text-muted-foreground">✓ No Credit Card Required</div>
            <div className="text-sm text-muted-foreground">✓ 30-Day Interview Guarantee</div>
            <div className="text-sm text-muted-foreground">✓ Skip Line with 3 Referrals</div>
          </div>
