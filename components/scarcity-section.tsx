            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex justify-between items-center text-sm">
                  <span
                    className="text-cyan font-semibold transition-all duration-300"
                    style={{
              ...
              <div className="mt-4 h-6">
                {isComplete && (
                  <div className="text-cyan font-medium animate-fade-in">⚠️ Limited spots available - Act fast!</div>
                )}
              </div>
            </div>
          </div>
