  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-midnight-light">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-muted-foreground mb-8">Join 3,800+ job seekers on the waitlist today.</p>
        ...
        {/* Launch Info */}
        <div className="mb-8">
          <p className="text-cyan font-semibold text-lg">🚀 Launching March 1, 2025</p>
        </div>
