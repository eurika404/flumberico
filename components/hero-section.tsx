          ...
          <div className="relative h-96 bg-gradient-to-br from-midnight-light to-midnight rounded-2xl border border-border overflow-hidden animate-slide-in-right">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center space-y-4 animate-float">
                ...
                <div className="text-4xl animate-float-slow" style={{ animationDelay: "1s" }}>
                  🤖
                </div>
                <p className="text-cyan font-semibold">Flumberico applies to 200+ jobs</p>
                <p className="text-muted-foreground">Gets 15+ interviews</p>
              </div>
            </div>
